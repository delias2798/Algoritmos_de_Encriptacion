 ...
 * DES es un algoritmo de encriptación por bloques, consiste
 * en tomar un bloque de datos de longitud fija de bits y
 * se transforma mediante una serie de operaciones a
 * otro bloque ya encriptado de la misma longitud.*/
...
void pKEY(int &l,int &r){
    int map[56]={57,49,41,33,25,17,9,1,58,50,42,34,26,18,10,2,59,51,43,35,27,19,11
...
void pSUBKEY(int &l,int &r){
    int map[48]={14,17,11,24,1,5,3,28,15,6,21,10,23,19,12,4,26,8,16,7,27,20
...
void pIP(int &l,int &r){
    int map[64]={58,50,42,34,26,18,10,2,60,52,44,36,28,20,12,4,62,54
...
void funcE(int &l,int &r){
    int map[48]={32,1,2,3,4,5,4,5,6,7,8,9,8,9,10,11,12,13,12,13,14,15,16
...
int lastP(int s){
    int map[32]={16,7,20,21,29,12,28,17,1,15,23,26,5,18,31,10,2,8,24,14
